...
public class MaxPathTreeCountTest {
    ...
    @Test
    public void testMaxPathCountOne() {
        ...
        TreeNode root = new TreeNode(3, B1, B2);

        int result = MaxPathTreeCount.maxPathCount(root);

        assertEquals(2, result);
    }

    @Test
    public void testMaxPathCountTwo() {
    ...
    @Test
    public void testMaxPathCountThree() {
