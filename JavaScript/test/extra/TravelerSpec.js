(function(){
    describe("TravelerSpec", function () {

        it("testMinimizeTravel", function () {
            var adjacencyMatrix = [
                [0, 1, 2],
                [1, 0, 1],
                [2, 1, 0]
        ...
        it("testMinimizeTravelMedium", function () {
            var adjacencyMatrix = [
                [0, 3, 4, 3, 4],
                [3, 0, 4, 3, 4],
                [4, 4, 0, 3, 4],
        ...
        it("testMinimizeTravelHard", function () {
            var adjacencyMatrix = [
        ...
        it("testMinimizeTravelCrazy", function () {
            var adjacencyMatrix = [
